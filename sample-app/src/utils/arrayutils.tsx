 ...
 * @returns {Object}
 */
export function groupArray (arr: Array<any>, keyFunc: Function, valueFunc: Function, initial: Object) {
  keyFunc = keyFunc || ((key: any) => key);
  valueFunc = valueFunc || ((value: any) => value);
