...
export default function useRecentSearches(recentSearchesLimit: number): [RecentSearches|undefined, () => void, () => void] {
  ...
  const createNewRecentSearchesStorage = useCallback(() => {
    setRecentSeaches(new RecentSearches({ limit: recentSearchesLimit, namespace: RECENT_SEARCHES_KEY }));
  }, [recentSearchesLimit]);
